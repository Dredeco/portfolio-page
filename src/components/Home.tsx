...
export function Home() {
    return (
        <div id='home' className="lg:flex-row pt-28 lg:pt-32 lg:h-full w-full flex flex-col-reverse relative items-center px-20">
            ...
            <div className="relative h-auto w-[140%] sm:w-[80%] lg:w-[50%] flex justify-center items-center lg:mb-20">
